																	...
																	<?php foreach ($rows as $row): ?>
																		<tr data-kelas="<?= $row->kelas ?>">
																			...
																			<td class="text-center">
																				<a href="<?= base_url('mapel/edit_absensi/' . $row->id_absensi); ?>" class="badge badge-success">Edit</a>

																				<?php if (!empty($row->file_surat)): ?>
																					<a href="<?= base_url('assets/surat/' . $row->file_surat); ?>" 
																					target="_blank" 
																					class="badge badge-primary" 
																					download="<?= $row->file_surat ?>">Unduh Surat</a>
																				<?php endif; ?>
																			</td>
